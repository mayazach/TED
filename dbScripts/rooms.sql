...
INSERT INTO room (id,ownerid,name,url,description,guests,maxguests,price,pricePerExtra,pricePerWeek,pricePerMonth,squareMetres,roomType,
	...
	rules,reviews,reviewAvg,dateFrom,dateTo)
	...
	null,16,94,'2017-01-01','2017-12-31');
INSERT INTO room (id,ownerid,name,url,description,guests,maxguests,price,pricePerExtra,pricePerWeek,pricePerMonth,squareMetres,roomType,
	beds,bedrooms,bathrooms,thumbnail,defaultPic,floor,neighborhoodOverview,address,postalCode,city,state,country,transport,amenities,
	rules,reviews,reviewAvg,dateFrom,dateTo)
...
INSERT INTO room (id,ownerid,name,url,description,guests,maxguests,price,pricePerExtra,pricePerWeek,pricePerMonth,squareMetres,roomType,
	...
	'1st','Plaka','Vyronos, Athina, 105 58, Greece','105 58','Athens','Attica',2,null,'{TV,"Cable TV",Internet,"Wireless Internet","Air Conditioning",Kitchen,Heating,"Family/Kid Friendly",Washer,Essentials,Shampoo}',
	null,16,94,'2000-01-01','2099-12-31');
INSERT INTO room (id,ownerid,name,url,description,guests,maxguests,price,pricePerExtra,pricePerWeek,pricePerMonth,squareMetres,roomType,
	beds,bedrooms,bathrooms,thumbnail,defaultPic,floor,neighborhoodOverview,address,postalCode,city,state,country,transport,amenities,
	rules,reviews,reviewAvg,dateFrom,dateTo)
	...
	'1st',null,'Vyronos, Athina, 105 58, Greece','105 58','Athens','Attica',2,null,'{Kitchen,"Buzzer/Wireless Intercom",Heating,"Family/Kid Friendly",Washer,Parking}',
	null,16,94,'2000-01-01','2099-12-31');
INSERT INTO room (id,ownerid,name,url,description,guests,maxguests,price,pricePerExtra,pricePerWeek,pricePerMonth,squareMetres,roomType,
	beds,bedrooms,bathrooms,thumbnail,defaultPic,floor,neighborhoodOverview,address,postalCode,city,state,country,transport,amenities,
	rules,reviews,reviewAvg,dateFrom,dateTo)
...
INSERT INTO room (id,ownerid,name,url,description,guests,maxguests,price,pricePerExtra,pricePerWeek,pricePerMonth,squareMetres,roomType,
	...
	'1st',null,'Vyronos, Athina, 105 58, Greece','105 58','Athens','Attica',2,null,'{}',
	null,16,94,'2017-01-01','2019-06-30');
INSERT INTO room (id,ownerid,name,url,description,guests,maxguests,price,pricePerExtra,pricePerWeek,pricePerMonth,squareMetres,roomType,
	beds,bedrooms,bathrooms,thumbnail,defaultPic,floor,neighborhoodOverview,address,postalCode,city,state,country,transport,amenities,
	rules,reviews,reviewAvg,dateFrom,dateTo)
	...
	'1st','Attiki','Vyronos, Athina, 105 58, Greece','105 58','Athens','Attica',2,null,'{Internet,"Wireless Internet",Kitchen,Heating,Parking}',
	null,16,94,'2017-01-01','2019-06-30');
INSERT INTO room (id,ownerid,name,url,description,guests,maxguests,price,pricePerExtra,pricePerWeek,pricePerMonth,squareMetres,roomType,
	beds,bedrooms,bathrooms,thumbnail,defaultPic,floor,neighborhoodOverview,address,postalCode,city,state,country,transport,amenities,
	rules,reviews,reviewAvg,dateFrom,dateTo)
...
INSERT INTO room (id,ownerid,name,url,description,guests,maxguests,price,pricePerExtra,pricePerWeek,pricePerMonth,squareMetres,roomType,
	...
	'1st',null,'Vyronos, Athina, 105 58, Greece','105 58','Athens','Attica',2,null,'{TV,"Air Conditioning",Kitchen,"Elevator in Building",Heating,Washer,Dryer,Parking}',
	null,16,94,'2017-01-01','2019-06-30');
INSERT INTO room (id,ownerid,name,url,description,guests,maxguests,price,pricePerExtra,pricePerWeek,pricePerMonth,squareMetres,roomType,
	beds,bedrooms,bathrooms,thumbnail,defaultPic,floor,neighborhoodOverview,address,postalCode,city,state,country,transport,amenities,
	rules,reviews,reviewAvg,dateFrom,dateTo)
...
INSERT INTO room (id,ownerid,name,url,description,guests,maxguests,price,pricePerExtra,pricePerWeek,pricePerMonth,squareMetres,roomType,
	...
	null,16,94,'2018-04-01','2018-10-31');
INSERT INTO room (id,ownerid,name,url,description,guests,maxguests,price,pricePerExtra,pricePerWeek,pricePerMonth,squareMetres,roomType,
	beds,bedrooms,bathrooms,thumbnail,defaultPic,floor,neighborhoodOverview,address,postalCode,city,state,country,transport,amenities,
	rules,reviews,reviewAvg,dateFrom,dateTo)
